...
export class Backend implements backendInterface {
    ...
    async createQuestion(arg0: string, arg1: Array<string>, arg2: bigint, arg3: string, arg4: string): Promise<bigint> {
    ...
    async updateQuestion(arg0: bigint, arg1: Question): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateQuestion(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
